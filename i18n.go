...
var translations = map[string]Translations{
	...
	"santa_wish_make":          {"fr": "Pour ceux qui n'ont pas d'argent, quelque chose qui peut être fabriqué ou trouvé", "en": "For those who have time, something that can be made or found"},
	"santa_wish_make_hint":     {"fr": "Une plante, un plat, un poème, une prière…", "en": "A plant, a dish, a poem, a prayer…"},
	...
	"santa_wishes_saved_body":  {"fr": "Revenez la modifier à tout moment grâce au lien personnel que vous avez reçu par email.", "en": "Come back to edit it any time using the personal link you received by email."},
	...
	"santa_admin_drawn_title":          {"fr": "Tirage effectué", "en": "Draw completed"},
	...
	"santa_admin_section_list":         {"fr": "Liste détaillée", "en": "Detailed list"},
